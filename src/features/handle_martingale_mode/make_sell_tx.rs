...
pub fn make_sell_tx(token_data: &TokenDatabaseSchema) {
    let sell_ix: Instruction = token_data
        .clone()
        .pump_fun_swap_accounts
        .get_sell_ix((token_data.token_balance as f64 * 0.3) as u64);
    ...
    let tag = format!(
        ...
        token_data.token_mint, token_data.token_price, (token_data.token_balance as f64 * 0.3) as u64,
    );
